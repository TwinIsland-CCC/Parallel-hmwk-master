...
df = pd.read_csv('benchmark_20250614_140413.csv')
...
plt.title('All Algorithms Performance Comparison O2', fontsize=28, fontweight='bold', pad=15)
plt.xticks(x_base + bar_width * (len(methods) - 1) / 2, [str(s) for s in sizes], fontsize=16)
